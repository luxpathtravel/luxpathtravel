...
const Breadcrumbs = {
  render(pkg) {
    ...
    list.innerHTML = `
      ...
      <li class="breadcrumbs__item">
        <a href="بكجات-سياحية-اندونيسيا.html">${I18n.t('breadcrumb.packages')}</a>
      </li>
      ${destName ? `<li class="breadcrumbs__item"><a href="وجهة-سياحية-اندونيسيا.html?slug=${destSlug}">${destName}</a></li>` : ''}
