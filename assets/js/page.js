...
const T = {
  ar: {
    ...
    'about.story.p3':       'ثقة أكثر من 2,000 عائلة سعودية وعرسان سعوديين سافروا معنا تتحدث أكثر مما تقوله الإعلانات. كل رحلة تبدأ بمحادثة على واتساب وتنتهي بذكريات تدوم.',
    ...
    'contact.phone.value':  '+62 811-1182-6527',
    'contact.phone.note':   'على مدار الأسبوع، 9 ص — 9 م',
    'contact.email.label':  'البريد الإلكتروني',
    'contact.email.value':  'info@luxpathtravel.com',
    'contact.email.note':   'نرد خلال 4 ساعات عمل',
    'contact.hours.label':  'ساعات العمل',
    'contact.hours.value':  'على مدار الأسبوع',
    'contact.hours.note':   '9:00 ص — 9:00 م (بتوقيت الرياض)',
    'contact.wa.hero.title':'أسرع طريقة للتواصل',
    'contact.wa.hero.sub':  'أرسل لنا رسالة على واتساب وسنرد على الفور. خبراؤنا جاهزون لتصميم رحلتك المثالية.',
  ...
  en: {
    ...
    'about.story.p3':       'The trust of over 2,000 Saudi families & couples who have travelled with us speaks louder than any advertisement. Every trip starts with a WhatsApp conversation and ends with memories that last.',
